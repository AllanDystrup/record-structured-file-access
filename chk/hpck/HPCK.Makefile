...
# allan@LAPTOP-6UIHQ2QE:/mnt/c/Users/allan/CLionProjects/ACCESS/util/chk/hpck$ make -f HPCK.Makefile test
#			string1 : [ABCDEFGHIJ]
#			string2 : [12345]
...
# [2] BUILD ----- make -f HPCK.Makefile  -------------------------------------
CC = gcc
# TEST DRIVER
CFLAGS = -DMAIN -DHDEBUG -g
# LIB
# CFLAGS = -g
LIBS = -lm
